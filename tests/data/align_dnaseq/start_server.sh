...
bsub -n 1 -q dinglab-interactive -G compute-dinglab -a 'docker(mwyczalkowski/cromwell-runner)' -g /estorrs/test_cromwell -J cd192545-124d-4b14-abaa-519f8f0b8334 -Is '/bin/bash'