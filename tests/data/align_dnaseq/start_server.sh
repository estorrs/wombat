...
bsub -n 1 -q dinglab-interactive -G compute-dinglab -a 'docker(mwyczalkowski/cromwell-runner)' -g /estorrs/test_cromwell -J eeb1362d-5f9a-46e6-b3c7-838f4c2ffc30 -Is '/bin/bash'