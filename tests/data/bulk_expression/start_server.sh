...
bsub -n 1 -q dinglab-interactive -G compute-dinglab -a 'docker(mwyczalkowski/cromwell-runner)' -g /estorrs/test_cromwell -J c384cc13-1603-4d9f-a27f-3728148093be -Is '/bin/bash'