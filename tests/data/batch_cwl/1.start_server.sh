...
bsub -q dinglab-interactive -G compute-dinglab -a 'docker(mwyczalkowski/cromwell-runner)' -g /estorrs/test_cromwell_hello -J 7f4d2ae7-a056-4778-af3d-15c4a9b7c162 -Is '/bin/bash'