...
bsub -n 1 -q dinglab-interactive -G compute-dinglab -a 'docker(mwyczalkowski/cromwell-runner)' -g /estorrs/test_cromwell -J 17ffa883-8f0f-4533-a7b4-dd0bd9758077 -Is '/bin/bash'